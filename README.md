...
The following preprocessing steps were performed:
  ...
  -Identifying **Numeric** and **Categorical** columns they were processed differently Numeric missing values were filled with median, and Categorical missing values were filled with most frequent value. Categorical variables were also converted into numbers using **one-hot encoding**.
